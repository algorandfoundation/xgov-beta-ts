...
export declare class ProposalClient {
    ...
    readonly send: {
        ...
        delete: {
             ...
             */
            delete: (params?: CallParams<ProposalArgs["obj"]["delete()void"] | ProposalArgs["tuple"]["delete()void"]> & SendParams & {
                onComplete?: OnApplicationComplete.DeleteApplication;
            }) => Promise<{
    ...
    newGroup(composerConfig?: TransactionComposerConfig): ProposalComposer;
}
