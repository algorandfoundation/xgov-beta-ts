import * as _algorandfoundation_algokit_utils_types_app_arc567 from "@algorandfoundation/algokit-utils/types/app-arc56";
...
import * as _algorandfoundation_algokit_utils_types_account0 from "@algorandfoundation/algokit-utils/types/account";
import * as _algorandfoundation_algokit_utils_types_amount1 from "@algorandfoundation/algokit-utils/types/amount";
import * as _algorandfoundation_algokit_utils_types_app_manager4 from "@algorandfoundation/algokit-utils/types/app-manager";
import * as algosdk6 from "algosdk";
import { OnApplicationComplete, Transaction, TransactionSigner, modelsv2 } from "algosdk";
import * as _algorandfoundation_algokit_utils_types_app20 from "@algorandfoundation/algokit-utils/types/app";
import { ABIReturn } from "@algorandfoundation/algokit-utils/types/app";
import * as _algorandfoundation_algokit_utils_types_transaction40 from "@algorandfoundation/algokit-utils/types/transaction";
import { SendAtomicTransactionComposerResults, SendParams } from "@algorandfoundation/algokit-utils/types/transaction";
import * as _algorandfoundation_algokit_utils_types_composer67 from "@algorandfoundation/algokit-utils/types/composer";
...
//#region src/ProposalClient.d.ts
 ...
 */
declare function ProposalTypedGlobalStateFromTuple(abiTuple: [string, bigint, string, bigint, bigint, bigint, bigint, bigint, number, bigint, bigint, bigint, Uint8Array, bigint, bigint, bigint, bigint, bigint, bigint]): ProposalTypedGlobalState;
/**
 ...
 */
type ProposalSignatures = keyof ProposalTypes['methods'];
/**
 * Defines the possible abi call signatures for methods that return a non-void value.
 */
type ProposalNonVoidMethodSignatures = keyof ProposalTypes['methods'] extends infer T ? T extends keyof ProposalTypes['methods'] ? MethodReturn<T> extends void ? never : T : never : never;
/**
 ...
 */
type MethodArgs<TSignature extends ProposalSignatures> = ProposalTypes['methods'][TSignature]['argsObj' | 'argsTuple'];
/**
 * Maps a method signature from the Proposal smart contract to the method's return type
 */
type MethodReturn<TSignature extends ProposalSignatures> = ProposalTypes['methods'][TSignature]['returns'];
/**
 * Defines the shape of the keyed global state of the application.
 */
type GlobalKeysState = ProposalTypes['state']['global']['keys'];
/**
 * Defines supported create method params for this smart contract
 */
type ProposalCreateCallParams = Expand<CallParams<ProposalArgs['obj']['create(address)void'] | ProposalArgs['tuple']['create(address)void']> & {
  method: 'create';
} & {
 ...
 */
type ProposalDeleteCallParams = Expand<CallParams<ProposalArgs['obj']['delete()string'] | ProposalArgs['tuple']['delete()string']> & {
  method: 'delete';
 ...
 */
type ProposalDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
 ...
 */
declare abstract class ProposalParamsFactory {
  /**
  ...
  static get create(): {
    _resolveByMethod<TParams extends ProposalCreateCallParams & {
      ...
      signer?: (TransactionSigner | _algorandfoundation_algokit_utils_types_account0.TransactionSignerAccount) | undefined;
      rekeyTo?: string | undefined;
      note?: (Uint8Array | string) | undefined;
      lease?: (Uint8Array | string) | undefined;
      staticFee?: _algorandfoundation_algokit_utils_types_amount1.AlgoAmount | undefined;
      extraFee?: _algorandfoundation_algokit_utils_types_amount1.AlgoAmount | undefined;
      maxFee?: _algorandfoundation_algokit_utils_types_amount1.AlgoAmount | undefined;
      ...
      boxReferences?: (_algorandfoundation_algokit_utils_types_app_manager4.BoxReference | _algorandfoundation_algokit_utils_types_app_manager4.BoxIdentifier)[] | undefined;
      sender?: string | undefined;
      method: string;
      args?: (algosdk6.ABIValue | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | AppMethodCallTransactionArgument | undefined)[] | undefined;
...
declare class ProposalFactory {
  ...
  deploy(params?: ProposalDeployParams): Promise<{
    result: {
      return: algosdk6.ABIValue | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | undefined;
      deleteReturn: algosdk6.ABIValue | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | undefined;
      compiledApproval?: _algorandfoundation_algokit_utils_types_app20.CompiledTeal | undefined;
      compiledClear?: _algorandfoundation_algokit_utils_types_app20.CompiledTeal | undefined;
      ...
      createdRound: bigint;
      updatedRound: bigint;
      createdMetadata: _algorandfoundation_algokit_utils_types_app20.AppDeployMetadata;
      deletable?: boolean | undefined;
      updatable?: boolean | undefined;
      groupId: string;
      txIds: string[];
      returns?: _algorandfoundation_algokit_utils_types_app20.ABIReturn[] | undefined;
      ...
      appId: bigint;
      appAddress: string;
      deleteResult: _algorandfoundation_algokit_utils_types_transaction40.ConfirmedTransactionResult;
    } | {
      return: algosdk6.ABIValue | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | undefined;
      deleteReturn: algosdk6.ABIValue | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | undefined;
      compiledApproval?: _algorandfoundation_algokit_utils_types_app20.CompiledTeal | undefined;
  ...
  readonly params: {
    ...
    create: {
      ...
      create: (params: CallParams<ProposalArgs["obj"]["create(address)void"] | ProposalArgs["tuple"]["create(address)void"]> & AppClientCompilationParams & CreateSchema & {
        ...
        deployTimeParams: _algorandfoundation_algokit_utils_types_app20.TealTemplateParams | undefined;
        schema: {
          globalInts: number;
        ...
        appReferences?: bigint[] | undefined;
        assetReferences?: bigint[] | undefined;
        boxReferences?: (_algorandfoundation_algokit_utils_types_app_manager4.BoxIdentifier | _algorandfoundation_algokit_utils_types_app_manager4.BoxReference)[] | undefined;
        sender?: string | undefined;
        method: string;
        args?: (algosdk6.ABIValue | AppMethodCallTransactionArgument | _algorandfoundation_algokit_utils_types_app_arc567.ABIStruct | undefined)[] | undefined;
        updatable?: boolean | undefined;
        deletable?: boolean | undefined;
        ...
        sender: string;
        signer: TransactionSigner | _algorandfoundation_algokit_utils_types_account0.TransactionSignerAccount | undefined;
        method: _algorandfoundation_algokit_utils_types_app_arc567.Arc56Method;
        args: (Transaction | algosdk6.ABIValue | algosdk6.TransactionWithSigner | Promise<Transaction> | _algorandfoundation_algokit_utils_types_composer67.AppMethodCall<{
          lease?: string | Uint8Array | undefined;
          note?: string | Uint8Array | undefined;
          maxFee?: _algorandfoundation_algokit_utils_types_amount1.AlgoAmount | undefined;
          ...
          extraProgramPages?: number | undefined;
        }> | _algorandfoundation_algokit_utils_types_composer67.AppMethodCall<{
          sender: string;
          signer?: TransactionSigner | _algorandfoundation_algokit_utils_types_account0.TransactionSignerAccount | undefined;
          rekeyTo?: string | undefined;
          note?: string | Uint8Array | undefined;
          ...
          approvalProgram: string | Uint8Array;
          clearStateProgram: string | Uint8Array;
        }> | _algorandfoundation_algokit_utils_types_composer67.AppMethodCall<_algorandfoundation_algokit_utils_types_composer67.AppMethodCallParams> | undefined)[] | undefined;
  ...
  readonly createTransaction: {
    ...
    create: {
      ...
      create: (params: CallParams<ProposalArgs["obj"]["create(address)void"] | ProposalArgs["tuple"]["create(address)void"]> & AppClientCompilationParams & CreateSchema & {
        ...
        transactions: Transaction[];
        methodCalls: Map<number, algosdk6.ABIMethod>;
...
declare class ProposalClient {
  ...
  readonly params: {
    ...
    delete: {
       ...
       */
      delete: (params?: CallParams<ProposalArgs["obj"]["delete()string"] | ProposalArgs["tuple"]["delete()string"]>) => Promise<_algorandfoundation_algokit_utils_types_composer67.AppDeleteMethodCall>;
    };
    /**
     ...
     */
    clearState: (params?: Expand<AppClientBareCallParams>) => _algorandfoundation_algokit_utils_types_composer67.AppCallParams;
    /**
...
type ProposalComposer<TReturns extends [...any[]] = []> = {
  /**
...
type ProposalComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
  returns: TReturns;
}>; //#endregion
export { APP_SPEC, BinaryState, CallParams, Expand, GlobalKeysState, MethodArgs, MethodReturn, ProposalArgs, ProposalClient, ProposalComposer, ProposalComposerResults, ProposalCreateCallParams, ProposalDeleteCallParams, ProposalDeployParams, ProposalFactory, ProposalNonVoidMethodSignatures, ProposalParamsFactory, ProposalReturns, ProposalSignatures, ProposalTypedGlobalState, ProposalTypedGlobalStateFromTuple, ProposalTypes };