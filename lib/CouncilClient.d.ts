...
import { AppClientMethodCallParams, AppClientCompilationParams, CallOnComplete, AppClient as _AppClient, AppClientParams, ResolveAppClientByCreatorAndName, ResolveAppClientByNetwork, AppClientBareCallParams, CloneAppClientParams } from '@algorandfoundation/algokit-utils/types/app-client';
import { SendParams, SendTransactionComposerResults } from '@algorandfoundation/algokit-utils/types/transaction';
import { AppFactoryAppClientParams, AppFactoryDeployParams, AppFactoryParams, AppFactory as _AppFactory, AppFactoryResolveAppClientByCreatorAndNameParams, CreateSchema } from '@algorandfoundation/algokit-utils/types/app-factory';
import { TransactionComposer, TransactionComposerConfig, SkipSignaturesSimulateOptions, RawSimulateOptions, AppMethodCallTransactionArgument } from '@algorandfoundation/algokit-utils/types/composer';
    ...
    readonly params: {
        ...
        create: {
            ...
            create: (params: CallParams<CouncilArgs["obj"]["create(uint64)void"] | CouncilArgs["tuple"]["create(uint64)void"]> & AppClientCompilationParams & CreateSchema & {
                ...
                args: (Transaction | import("@algorandfoundation/algokit-utils/abi").ABIValue | import("@algorandfoundation/algokit-utils").TransactionWithSigner | import("@algorandfoundation/algokit-utils/transactions/method-call").AppMethodCall<{
                    signer?: import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner | TransactionSigner | undefined;
                    ...
                    extraProgramPages?: number | undefined;
                }> | Promise<Transaction> | import("@algorandfoundation/algokit-utils/transactions/method-call").AppMethodCall<{
                    sender: import("@algorandfoundation/algokit-utils/transact").SendingAddress;
                    signer?: import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner | TransactionSigner | undefined;
                    rekeyTo?: import("@algorandfoundation/algokit-utils").ReadableAddress | undefined;
                    note?: string | Uint8Array | undefined;
                    ...
                    approvalProgram: string | Uint8Array;
                    clearStateProgram: string | Uint8Array;
                }> | import("@algorandfoundation/algokit-utils/transactions/method-call").AppMethodCall<import("@algorandfoundation/algokit-utils/transactions/app-call").AppMethodCallParams> | undefined)[] | undefined;
...
export declare class CouncilClient {
    ...
    readonly params: {
         ...
         */
        clearState: (params?: Expand<AppClientBareCallParams>) => import("@algorandfoundation/algokit-utils/transactions/app-call").AppCallParams;
        /**
        ...
        addMember: (params: CallParams<CouncilArgs["obj"]["add_member(address)void"] | CouncilArgs["tuple"]["add_member(address)void"]> & {
            ...
            args?: (Transaction | import("@algorandfoundation/algokit-utils/abi").ABIValue | import("@algorandfoundation/algokit-utils").TransactionWithSigner | import("@algorandfoundation/algokit-utils/transactions/method-call").AppMethodCall<{
                 ...
                 * @param params The arguments for the contract calls and any additional parameters for the call
                 * @returns The deployment result
                 */: import("@algorandfoundation/algokit-utils/transact").AddressWithTransactionSigner | TransactionSigner | undefined;
                sender: import("@algorandfoundation/algokit-utils/transact").SendingAddress;
                rekeyTo?: import("@algorandfoundation/algokit-utils").ReadableAddress | undefined;
                note?: string | Uint8Array | undefined;
                lease?: string | Uint8Array | undefined;
    ...
    readonly send: {
        ...
        update: {
             ...
             */
            updateCouncil: (params?: CallParams<CouncilArgs["obj"]["update_council()void"] | CouncilArgs["tuple"]["update_council()void"]> & AppClientCompilationParams & SendParams & {
                onComplete?: OnApplicationComplete.UpdateApplication;
            }) => Promise<{
    ...
    newGroup(composerConfig?: TransactionComposerConfig): CouncilComposer;
}
