import * as _algorandfoundation_algokit_utils_types_app_arc56132 from "@algorandfoundation/algokit-utils/types/app-arc56";
import { Arc56Contract } from "@algorandfoundation/algokit-utils/types/app-arc56";
import { AppClient, AppClientBareCallParams, AppClientCompilationParams, AppClientMethodCallParams, AppClientParams, CallOnComplete, CloneAppClientParams, ResolveAppClientByCreatorAndName, ResolveAppClientByNetwork } from "@algorandfoundation/algokit-utils/types/app-client";
import { AppFactory, AppFactoryAppClientParams, AppFactoryDeployParams, AppFactoryParams, AppFactoryResolveAppClientByCreatorAndNameParams, CreateSchema } from "@algorandfoundation/algokit-utils/types/app-factory";
import * as _algorandfoundation_algokit_utils_types_account125 from "@algorandfoundation/algokit-utils/types/account";
import * as _algorandfoundation_algokit_utils_types_amount126 from "@algorandfoundation/algokit-utils/types/amount";
import * as _algorandfoundation_algokit_utils_types_app_manager129 from "@algorandfoundation/algokit-utils/types/app-manager";
import * as algosdk131 from "algosdk";
import { OnApplicationComplete, Transaction, TransactionSigner, modelsv2 } from "algosdk";
import * as _algorandfoundation_algokit_utils_types_app145 from "@algorandfoundation/algokit-utils/types/app";
import { ABIReturn } from "@algorandfoundation/algokit-utils/types/app";
import * as _algorandfoundation_algokit_utils_types_transaction165 from "@algorandfoundation/algokit-utils/types/transaction";
import { SendAtomicTransactionComposerResults, SendParams } from "@algorandfoundation/algokit-utils/types/transaction";
import * as _algorandfoundation_algokit_utils_types_composer192 from "@algorandfoundation/algokit-utils/types/composer";
import { AppCallMethodCall, AppMethodCallTransactionArgument, RawSimulateOptions, SkipSignaturesSimulateOptions, TransactionComposer } from "@algorandfoundation/algokit-utils/types/composer";
import { AlgorandClient } from "@algorandfoundation/algokit-utils/types/algorand-client";

//#region src/XGovRegistryClient.d.ts
 ...
 */
declare function XGovRegistryConfigFromTuple(abiTuple: [bigint, bigint, bigint, bigint, bigint, bigint, [bigint, bigint, bigint], [bigint, bigint, bigint, bigint], [bigint, bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint]]): XGovRegistryConfig;
 ...
 */
declare function TypedGlobalStateFromTuple(abiTuple: [boolean, boolean, string, string, string, string, string, string, string, bigint, bigint, bigint, bigint, bigint, bigint, [bigint, bigint, bigint], [bigint, bigint, bigint, bigint], [bigint, bigint, bigint, bigint], [bigint, bigint, bigint], [bigint, bigint, bigint], bigint, bigint, Uint8Array, bigint, bigint]): TypedGlobalState;
/**
 * The argument types for the XGovRegistry contract
 */
type XGovRegistryArgs = {
  /**
 ...
 */
type XGovRegistrySignatures = keyof XGovRegistryTypes['methods'];
/**
 * Defines the possible abi call signatures for methods that return a non-void value.
 */
type XGovRegistryNonVoidMethodSignatures = keyof XGovRegistryTypes['methods'] extends infer T ? T extends keyof XGovRegistryTypes['methods'] ? MethodReturn<T> extends void ? never : T : never : never;
/**
 ...
 */
type MethodArgs<TSignature extends XGovRegistrySignatures> = XGovRegistryTypes['methods'][TSignature]['argsObj' | 'argsTuple'];
/**
 * Maps a method signature from the XGovRegistry smart contract to the method's return type
 */
type MethodReturn<TSignature extends XGovRegistrySignatures> = XGovRegistryTypes['methods'][TSignature]['returns'];
/**
 * Defines the shape of the keyed global state of the application.
 */
type GlobalKeysState = XGovRegistryTypes['state']['global']['keys'];
/**
 * Defines supported create method params for this smart contract
 */
type XGovRegistryCreateCallParams = Expand<CallParams<XGovRegistryArgs['obj']['create()void'] | XGovRegistryArgs['tuple']['create()void']> & {
  method: 'create';
} & {
 ...
 */
type XGovRegistryUpdateCallParams = Expand<CallParams<XGovRegistryArgs['obj']['update_xgov_registry()void'] | XGovRegistryArgs['tuple']['update_xgov_registry()void']> & {
 ...
 */
type XGovRegistryDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
 ...
 */
declare abstract class XGovRegistryParamsFactory {
  /**
  ...
  static get create(): {
    _resolveByMethod<TParams extends XGovRegistryCreateCallParams & {
      ...
      signer?: (TransactionSigner | _algorandfoundation_algokit_utils_types_account125.TransactionSignerAccount) | undefined;
      rekeyTo?: string | undefined;
      note?: (Uint8Array | string) | undefined;
      lease?: (Uint8Array | string) | undefined;
      staticFee?: _algorandfoundation_algokit_utils_types_amount126.AlgoAmount | undefined;
      extraFee?: _algorandfoundation_algokit_utils_types_amount126.AlgoAmount | undefined;
      maxFee?: _algorandfoundation_algokit_utils_types_amount126.AlgoAmount | undefined;
      ...
      boxReferences?: (_algorandfoundation_algokit_utils_types_app_manager129.BoxReference | _algorandfoundation_algokit_utils_types_app_manager129.BoxIdentifier)[] | undefined;
      sender?: string | undefined;
      method: string;
      args?: (algosdk131.ABIValue | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | AppMethodCallTransactionArgument | undefined)[] | undefined;
 ...
 */
declare class XGovRegistryFactory {
  /**
  ...
  deploy(params?: XGovRegistryDeployParams): Promise<{
    result: {
      return: algosdk131.ABIValue | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | undefined;
      deleteReturn: algosdk131.ABIValue | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | undefined;
      compiledApproval?: _algorandfoundation_algokit_utils_types_app145.CompiledTeal | undefined;
      compiledClear?: _algorandfoundation_algokit_utils_types_app145.CompiledTeal | undefined;
      ...
      createdRound: bigint;
      updatedRound: bigint;
      createdMetadata: _algorandfoundation_algokit_utils_types_app145.AppDeployMetadata;
      deletable?: boolean | undefined;
      updatable?: boolean | undefined;
      groupId: string;
      txIds: string[];
      returns?: _algorandfoundation_algokit_utils_types_app145.ABIReturn[] | undefined;
      ...
      appId: bigint;
      appAddress: string;
      deleteResult: _algorandfoundation_algokit_utils_types_transaction165.ConfirmedTransactionResult;
    } | {
      return: algosdk131.ABIValue | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | undefined;
      deleteReturn: algosdk131.ABIValue | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | undefined;
      compiledApproval?: _algorandfoundation_algokit_utils_types_app145.CompiledTeal | undefined;
  ...
  readonly params: {
    ...
    create: {
      ...
      create: (params?: CallParams<XGovRegistryArgs["obj"]["create()void"] | XGovRegistryArgs["tuple"]["create()void"]> & AppClientCompilationParams & CreateSchema & {
        ...
        deployTimeParams: _algorandfoundation_algokit_utils_types_app145.TealTemplateParams | undefined;
        schema: {
          globalInts: number;
        ...
        appReferences?: bigint[] | undefined;
        assetReferences?: bigint[] | undefined;
        boxReferences?: (_algorandfoundation_algokit_utils_types_app_manager129.BoxIdentifier | _algorandfoundation_algokit_utils_types_app_manager129.BoxReference)[] | undefined;
        sender?: string | undefined;
        method: string;
        args?: (algosdk131.ABIValue | AppMethodCallTransactionArgument | _algorandfoundation_algokit_utils_types_app_arc56132.ABIStruct | undefined)[] | undefined;
        updatable?: boolean | undefined;
        deletable?: boolean | undefined;
        ...
        sender: string;
        signer: TransactionSigner | _algorandfoundation_algokit_utils_types_account125.TransactionSignerAccount | undefined;
        method: _algorandfoundation_algokit_utils_types_app_arc56132.Arc56Method;
        args: (Transaction | algosdk131.ABIValue | algosdk131.TransactionWithSigner | Promise<Transaction> | _algorandfoundation_algokit_utils_types_composer192.AppMethodCall<{
          lease?: string | Uint8Array | undefined;
          note?: string | Uint8Array | undefined;
          maxFee?: _algorandfoundation_algokit_utils_types_amount126.AlgoAmount | undefined;
          ...
          extraProgramPages?: number | undefined;
        }> | _algorandfoundation_algokit_utils_types_composer192.AppMethodCall<{
          sender: string;
          signer?: TransactionSigner | _algorandfoundation_algokit_utils_types_account125.TransactionSignerAccount | undefined;
          rekeyTo?: string | undefined;
          note?: string | Uint8Array | undefined;
          ...
          approvalProgram: string | Uint8Array;
          clearStateProgram: string | Uint8Array;
        }> | _algorandfoundation_algokit_utils_types_composer192.AppMethodCall<_algorandfoundation_algokit_utils_types_composer192.AppMethodCallParams> | undefined)[] | undefined;
  ...
  readonly createTransaction: {
    ...
    create: {
      ...
      create: (params?: CallParams<XGovRegistryArgs["obj"]["create()void"] | XGovRegistryArgs["tuple"]["create()void"]> & AppClientCompilationParams & CreateSchema & {
        ...
        transactions: Transaction[];
        methodCalls: Map<number, algosdk131.ABIMethod>;
 ...
 */
declare class XGovRegistryClient {
  /**
  ...
  readonly params: {
     ...
     */
    clearState: (params?: Expand<AppClientBareCallParams>) => _algorandfoundation_algokit_utils_types_composer192.AppCallParams;
    /**
...
type XGovRegistryComposer<TReturns extends [...any[]] = []> = {
  /**
...
type XGovRegistryComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
  returns: TReturns;
}>; //#endregion
export { APP_SPEC, BinaryState, CallParams, Expand, GlobalKeysState, MethodArgs, MethodReturn, TypedGlobalState, TypedGlobalStateFromTuple, XGovRegistryArgs, XGovRegistryClient, XGovRegistryComposer, XGovRegistryComposerResults, XGovRegistryConfig, XGovRegistryConfigFromTuple, XGovRegistryCreateCallParams, XGovRegistryDeployParams, XGovRegistryFactory, XGovRegistryNonVoidMethodSignatures, XGovRegistryParamsFactory, XGovRegistryReturns, XGovRegistrySignatures, XGovRegistryTypes, XGovRegistryUpdateCallParams };