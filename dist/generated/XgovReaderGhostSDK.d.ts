 ...
 */
export declare function ShortProposalStateFromTuple(abiTuple: [bigint, string, bigint, bigint, string]): ShortProposalState;
/**
 ...
 */
export declare abstract class XgovReaderParamsFactory {
    /**
     * Gets available create ABI call param factories
     */
    static get create(): {
        _resolveByMethod<TParams extends XgovReaderCreateCallParams & {
            method: string;
        }>(params: TParams): {
 ...
 */
declare class XgovReaderFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): XgovReaderClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<XgovReaderClient>;
    /**
     ...
     */
    deploy(params?: XgovReaderDeployParams): Promise<{
        result: {
 ...
 */
declare class XgovReaderClient {
    /**
     ...
     */
    decodeReturnValue<TSignature extends XgovReaderNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
     * Returns a new `XgovReaderClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<XgovReaderClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<XgovReaderClient>;
...
export type XgovReaderComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<XgovReaderComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<XgovReaderComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<XgovReaderComposerResults<TReturns> & {
        simulateResponse: modelsv2.SimulateResponse;
    }>;
    /**
...
declare class GhostBase {
    static factory: typeof XgovReaderFactory;
    static client: typeof XgovReaderClient;
    algorand: AlgorandClient;
    readerAccount: string;
    factory: XgovReaderFactory;
    private client;
    constructor({ algorand, readerAccount }: {
        algorand: AlgorandClient;
        readerAccount?: string;
    });
    protected execute<T>({ transactions, signature, extraSimulateArgs, }: {
        transactions: Transaction[];
        signature: string;
        extraSimulateArgs?: RawSimulateOptions;
    }): Promise<T[]>;
}
export declare class XgovReaderSDK extends GhostBase {
    constructor(args: ConstructorParameters<typeof GhostBase>[0]);
    getShortProposalState(args: Methods['getShortProposalState']['argsObj'], extraMethodCallArgs?: ExtraMethodCallArgs, extraSimulateArgs?: RawSimulateOptions): Promise<Methods['getShortProposalState']['returns'][]>;
}
export {};
