 ...
 */
export function requestBoxName(id: number | bigint): Uint8Array {
  return new Uint8Array(
    Buffer.concat([
      Buffer.from("r"),
 ...
 * Format: "M"
 */
export function metadataBoxName(): Uint8Array {
 ...
 */
export function councilVoteBoxName(proposalId: number | bigint): Uint8Array {
  return new Uint8Array(
    Buffer.concat([
      Buffer.from("V"),
